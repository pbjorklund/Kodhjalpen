...
ActiveRecord::Schema.define(:version => 20120531151530) do
  ...
  add_index "charities", ["email"], :name => "index_charities_on_email", :unique => true
  add_index "charities", ["reset_password_token"], :name => "index_charities_on_reset_password_token", :unique => true
